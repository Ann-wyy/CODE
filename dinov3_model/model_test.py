...
# 用户提供的文件路径
TRAIN_NAME = f"BTXRD_{TARGET_IMAGE_SIZE}_{LEARNING_RATE}"
TRAIN_CSV_PATH = "/home/yyi/data/test_dataset/BTXRD/BTXRD_train.csv"
VAL_CSV_PATH = "/home/yyi/data/test_dataset/BTXRD/BTXRD_val.csv"
