...
def run_dinov3_pca_pipeline(
    ...
    print(f"图像处理参数已修改: Mean={processor.image_mean}, Std={processor.image_std}")
...
if __name__ == "__main__":
    ...
    LOCAL_Weights = True
    local_weights_path = "/data/truenas_B2/yyi/bone_logs_512/eval/manual_9999/teacher_checkpoint.pth"
    IMAGE_PATHS = [
        "/home/yyi/images/images/spine.png",
        "/home/yyi/images/images/leg.jpeg",
