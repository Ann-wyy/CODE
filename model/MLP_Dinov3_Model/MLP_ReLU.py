...
NUM_EPOCHS = 100
PATIENCE = 10 # 早停耐心值
RANDOM_SEED = 2025# 42, 100, 601, 1010, 2025
...
# 用户提供的文件路径
TRAIN_NAME = "isCancer"
csv_path = f'/home/yyi/data/test_dataset/isCancer/isCancer_{RANDOM_SEED}'
TRAIN_CSV_PATH = f"{csv_path}_train.csv"
VAL_CSV_PATH = f"{csv_path}_val.csv"
TEST_CSV_PATH = f"{csv_path}_test.csv"
...
def train_multi_task_classifier(logger: logging.Logger):
    global IMAGE_PATH_COLUMN, LABEL_COLUMNS, TRAIN_CSV_PATH, VAL_CSV_PATH, TEST_CSV_PATH
    # 1. 初始化预处理器
